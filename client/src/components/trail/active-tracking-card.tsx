...
export default function ActiveTrackingCard({
  ...
  return (
    <Card
      className="bg-gradient-to-r from-sage to-forest text-white rounded-xl p-4 shadow-lg"
      data-testid="active-tracking-card"
    >
      <div className="flex items-center justify-between mb-3">
        <h3
          className="font-semibold text-lg"
          data-testid="text-current-hike-title"
        >
          Current Hike
        </h3>
      ...
      <div className="grid grid-cols-3 gap-4 text-center mb-4">
        <div>
          <div
            ...
            data-testid="text-current-distance"
          >
        ...
        <div>
          <div
            className="text-2xl font-bold"
            data-testid="text-current-elevation"
          >
        ...
        <div>
          <div
            className="text-2xl font-bold"
            data-testid="text-current-duration"
          >
